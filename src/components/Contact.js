                ...
                <div class="row justify-content-center">
                    <div class="col-6">
                        <form>
                            ...
                            <input required className="m-2 p-2 w-100 mx-auto rounded-2" type="text" id="email"></input>
                            <p>What do you want to say?</p>
                            <textarea required className="m-2 p-2 w-100 mx-auto rounded-2" type="text" id="message"></textarea>
                            <button className="m-2 p-2 w-100 mx-auto btn rounded-2" type="submit" id="submit">Submit</button  >
                        </form>
                    </div>
                </div>
