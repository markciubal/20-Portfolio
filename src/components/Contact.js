            ...
            <div className="col-12">
                <div className="h-100 p-5 rounded-3">
                    ...
                    <div class="row  justify-content-center">
                        <div class="col-6">
                            <form>
                                <input disabled className="m-2 p-2 w-100 mx-auto rounded-2" type="text" id="name" placeholder="What should I call you?"></input>
                                <input disabled className="m-2 p-2 w-100 mx-auto rounded-2" type="text" id="email" placeholder="How can I reach you?"></input>
                                <input disabled className="m-2 p-2 w-100 mx-auto rounded-2" type="text" id="message" placeholder="What do you want to say?"></input>
                                <button disabled className="m-2 p-2 w-100 mx-auto btn rounded-2" type="button" id="submit">Submit</button  >
                            </form>
                        </div>
                    </div>
