...
function Portfolio() {
    ...
    return (                
        <>
            ...
            <div id="guardian" className="row h-100 p-2 g-col-6">
                <Parallax
                    bgImage="guardian.jpg"
                    strength={300}
                    blur={{ min: -15, max: 15 }}
                    className="rounded-3"
                >
                    <div id="portfolio-chorechampion" className="row justify-content-center my-4 rounded-3">
                        <div className="col-12 col-md-4 p-3 portfolio-item-transparent align-items-center text-center align-self-center d-flex rounded-3">
                            <div className="mx-auto w-100 py-4 my-4">
                                ...
                                <img src="guardian.svg" style={{height: "25px"}}></img><span style={{verticalAlign: 'middle', fontSize: '20pt'}}> Guardian</span>
                                <p>Guardian is a tool to help educators track and identify the progress of students. It is mainly for special populations (veterans, DSPS, EOPS, ec.)</p>
                                <a className="btn rounded-2" href="https://guardian-app-37829fe04dc9.herokuapp.com/" target="_blank" rel="noreferrer">Guardian</a> 
                            </div>
                        </div>
                        ...
                        <div className="p-3 align-items-center container-fluid align-self-center col-12 col-md-12 col-lg-4">
                            <h1 className="knock-out-text text-left">Learn together.</h1>
                        </div>
                    </div>
                </Parallax>
            </div>
